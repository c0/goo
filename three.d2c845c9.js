...
var Ball = /*#__PURE__*/function () {
  function Ball(x, y) {
    ...
    this.vx = (VELOCITY / 4 + Math.random() * (1 - VELOCITY)) * Math.cos(this.angle);
...
var GOOP_X_OFFSET = 50;

var GoopLine = /*#__PURE__*/function () {
  function GoopLine(x, thickness) {
...
var randomCount = 1;
var goopLines = [];
var GOOP_LINE_COUNT = Math.floor(width / 100);

for (var i = 0; i < GOOP_LINE_COUNT; i++) {
  goopLines.push(new GoopLine(i * (width / GOOP_LINE_COUNT) + (50 * Math.random() - 50), randBetween(5, 50)));
}

var ballMakerSpeed = 50;
...
function loop() {
  ...
  ctx.fillRect(0, height * (1 - halfPercentage) - 30, width, height * halfPercentage + 30); // Create a new ball
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","three.js"], null)
//# sourceMappingURL=/three.d2c845c9.js.map