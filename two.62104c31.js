...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"two.js":[function(require,module,exports) {
...
var GOOP_Y_OFFSET = 50;

var GoopLine = /*#__PURE__*/function () {
  function GoopLine(y, thickness, droop) {
    _classCallCheck(this, GoopLine);
  ...
  _createClass(GoopLine, [{
    key: "update",
    value: function update(lp, rp, percentage) {
      var mp = {
        x: (lp.x + rp.x) / 2,
        y: Math.max((this.ly + this.ry) / 2, (this.ly + this.ry) / 2 + (1 - percentage) * this.droop - GOOP_Y_OFFSET)
      };
      ...
      ctx.arcTo(mp.x, mp.y + t, lp.x, this.ly + t, this.r * 1.25 * (1 - percentage));
...
var ctx = canvas.getContext('2d'); // State
...
var randomCount = 1;
var goopLines = [];
var GOOP_LINE_COUNT = Math.floor(height / 150);

for (var i = 0; i < GOOP_LINE_COUNT; i++) {
  goopLines.push(new GoopLine(i * (height / GOOP_LINE_COUNT) + (50 * Math.random() - 50), randBetween(30, 50), randBetween(100, 300)));
}

var ballMakerSpeed = 10;
var BALL_MAKER_EDGE = 50;

function loop() {
  ctx.clearRect(0, 0, width, height);
  var halfPercentage = (1 - mouse.y / height) / 2;
  goopLines.forEach(function (goopLine) {
    goopLine.update({
  ...
  ctx.fillRect(width * (1 - halfPercentage) - 30, 0, width * halfPercentage + 30, height); // Create a new ball
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","two.js"], null)
//# sourceMappingURL=/two.62104c31.js.map